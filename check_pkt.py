...
condition = "(delta_coarse==25 || delta_coarse==26) && (l1ts_min_tcoarse<1299 || l1ts_min_tcoarse>1567) && tiger<4"
h1 = ROOT.TH2D("h1", condition, l1count_max, 0, l1count_max, 15, 0, 15)
h1.GetXaxis().SetTitle("count")
h1.GetYaxis().SetTitle("gemroc")
c1 = ROOT.TCanvas("c11", "c11", 100, 100, 1800, 1200)
...
condition = "(delta_coarse==25 || delta_coarse==26) && (l1ts_min_tcoarse<1299 || l1ts_min_tcoarse>1567) && tiger>3"
h1 = ROOT.TH2D("h1", condition, l1count_max, 0, l1count_max, 15, 0, 15)
h1.GetXaxis().SetTitle("count")
h1.GetYaxis().SetTitle("gemroc")
c1 = ROOT.TCanvas("c11", "c11", 100, 100, 1800, 1200)
